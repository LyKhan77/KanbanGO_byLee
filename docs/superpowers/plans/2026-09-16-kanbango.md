...
- [x] **Step 3: Configure Vite + Vitest**
...
- [x] **Step 5: Replace `src/App.vue` placeholder + `src/main.ts`**
...
- [x] **Step 3: Write `src/services/storage.ts`**
...
- [x] **Step 3: Write `src/stores/kanban.ts`**
...
- [x] **Step 1: Write `src/styles/tokens.css`**
...
- [x] **Step 1: Write `src/router/index.ts`**
...
- [x] **Step 2: Write stub views (replaced in Tasks 9–10)**
...
- [x] **Step 3: Write `src/components/AppShell.vue`**
...
- [x] **Step 1: Write `src/components/BoardRow.vue`**
...
- [x] **Step 2: Replace `src/components/BoardListBanner.vue` (the stub)**
...
- [x] **Step 3: Replace `src/views/BoardListView.vue` (the stub)**
...
- [x] **Step 1: Write `src/components/Column.vue`**
...
- [x] **Step 2: Replace `src/components/BoardBanner.vue` (the stub)**
...
- [x] **Step 3: Replace `src/views/BoardView.vue` (the stub)**
...
- [x] **Step 1: Write `src/components/KanbanCard.vue`**
...
- [x] **Step 2: Write `src/components/CardModal.vue` (stub)**
...
- [x] **Step 3: Replace `src/components/Column.vue`**
...
- [x] **Step 4: Replace `src/views/BoardView.vue`**
...
- [x] **Step 1: Write `src/components/LabelPicker.vue`**
...
- [x] **Step 2: Write `src/components/SubtaskList.vue`**
...
- [x] **Step 3: Replace `src/components/CardModal.vue`**
...
- [x] **Step 1: Replace `src/views/BoardView.vue`**
...
- [x] **Step 2: Replace `src/components/Column.vue`**
...
- [x] **Step 1: Replace `src/components/BoardBanner.vue`**
...
- [x] **Step 3: Dev walkthrough (manual smoke)**
...
- [x] **Step 4: Verify the save-failure path (spec §9)**
